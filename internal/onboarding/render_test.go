...
// The tables are compared byte for byte against text generated by the Python
// implementation from the same rows.
...
// An empty table falls back to a width of 10, as Python's max(default=10) does.
